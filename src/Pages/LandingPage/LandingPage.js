...
function LandingPage() {
    return (
        <>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Deluxe Abroad Packers-Mylapore</title>
                <link rel="canonical" href="https://deluxeabroadcouriers.com/" />
            ...
            <div className='special-section' data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className='special-row'>
                    <div className='special-card'><i className="fas fa-dollar-sign sym"></i>Lowest Market Price </div>
                    <div className='special-card'><i className="fas fa-shipping-fast sym"></i>Excess Baggage Packing </div>
                    <div className='special-card'><i className="fas fa-box-open sym"></i>Customized Packing </div>
                    <div className='special-card'><i className="fas fa-laptop-code sym"></i>Online Tracking </div>
                </div>
            </div>
            <div className='row container-lg mx-auto'>
                <figure className='col-lg-6 d-flex flex-column justify-content-center' data-aos="fade-up" data-aos-duration="1500">
                ...
                <div className='col-lg-6 p-lg-5' data-aos="zoom-in" data-aos-duration="1500"><div className='fast-del'><img src='./images/about.gif' alt='home-img' /></div></div>
            </div>
            <ContactUs />
        </>
    )
